export default function Footer() {
    return (
        <>
            <footer id="footer" class="bg-neutral-900 text-gray-400">
                <div class="container mx-auto px-6 py-12">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                        {/* Company Info  */}
                        <div class="space-y-4">
                            <h3 class="text-2xl font-bold text-white mb-4">TimeComplexity</h3>
                            <p class="text-sm">Empowering developers with efficient code analysis tools for better performance optimization.</p>
                            <div class="flex space-x-4">
                                ...
                                <a href="https://github.com/Abhi9shinde" class="text-gray-400 hover:text-white transition-colors">
                                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="http://www.linkedin.com/in/abhinavshinde" class="text-gray-400 hover:text-white transition-colors">
                                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="border-t border-gray-800 pt-8">
                        <div class="flex flex-col md:flex-row justify-between items-center">
                            <p class="text-sm">&copy; 2025 TimeComplexity. All rights reserved.</p>
