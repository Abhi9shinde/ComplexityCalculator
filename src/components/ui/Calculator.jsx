                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="max-w-4xl mx-auto bg-neutral-100 rounded-xl shadow-lg p-8">
                        ...
                        <div className="flex justify-center mb-8">
                            <button id="analyze-btn" className="flex bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-8 rounded-xl transition-colors animate__animated animate__pulse animate__infinite">
                                Analyze Time Complexity <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-5 mx-1 my-0.5">
                            ...
                            <div className="bg-white rounded-lg p-6 border border-gray-200">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-start">
                                        ...
                                        <p id="time-complexity-result" className="font-mono">O(n)</p>
                                    </div>
                                    <div className="flex items-start">
                                        <div className="mr-4">
                                            <span className="inline-block px-3 py-1 bg-green-100 text-green-800 rounded-full font-medium">Explanation</span>
                                        </div>
                                        <p id="explanation-result" className="text-gray-700"></p>
                                    </div>
                                </div>
                            </div>
                        </div>
