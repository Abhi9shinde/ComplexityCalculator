...
export default function Doc() {
  return (
    <>
      <section
        id="documentation"
        className="bg-neutral-900 py-20 border-b border-neutral-800"
      >
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="md:col-span-3 space-y-8">
              ...
              <div
                id="basics"
                className="bg-neutral-800 rounded-xl p-8 animate__animated animate__fadeInRight max-w-screen-lg"
              >
                <h3 className="text-2xl font-bold text-white mb-4">
                  Understanding Time Complexity
                </h3>
                <p className="text-gray-400 mb-4">
                  Time complexity is a measure of the amount of time an
                  algorithm takes to run as a function of the length of the
                  input.
                </p>
              ...
              <div
                ...
                className="bg-neutral-800 rounded-xl p-8 animate__animated animate__fadeInRight"
              >
                <h3 className="text-2xl font-bold text-white mb-4">
                  Supported Languages
                </h3>
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  ...
                  <div className="bg-neutral-700 p-4 rounded-lg text-center">
                    <span className="text-yellow-400">
                      <FontAwesomeIcon icon={faJs} className="mr-2" size="lg" />
                      JavaScript
                    </span>
                  </div>
                  <div className="bg-neutral-700 p-4 rounded-lg text-center">
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="border-l-4 border-green-500 pl-4">
                    ...
                    <p className="text-gray-400">
                      Expected time required for program execution.
                    </p>
                  </div>
